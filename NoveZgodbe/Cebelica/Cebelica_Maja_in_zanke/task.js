function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno 
		...
		itemTypes: {
			robot0: { img: ["bee_all_8_sides.png"], side: 60, nbStates: 8, offsetX: 0, zOrder: 8,
						category: {'robot': true}, },
			cvet: { num: 2, img: "flower_without_dust.png", zOrder: 2, category: {}, },
			prah: { num: 3, img: "flower_dust.png", zOrder: 1, category: {'transportable':true}, transOrder:0},
			sat: {num: 4, img: ["honeycomb_empty.png", "honeycomb_full.png", "honeycomb_full.png", "honeycomb_full.png"], zOrder: 2, },
		}, 
