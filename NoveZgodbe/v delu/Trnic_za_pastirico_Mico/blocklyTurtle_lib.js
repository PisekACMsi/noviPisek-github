	...
	var localLanguageStrings = {
		...
		sl: {
			...
			label: {											//Imena ukazov
				...
				turnleftamount: "obrni se za %1° v levo ↺",
				turnrightamount: "obrni se za %1° v desno ↻",
				turnleftamountvalue: "obrni se za %1 v levo ↺",
				turnrightamountvalue: "obrni se za %1 v desno ↻",
				turnleftamountvalue_noround: "obrni se za %1 Grad v levo ↺",
				turnrightamountvalue_noround: "obrni se za %1 Grad v desno ↻",
				turnleftamountvalue_options: "obrni se za %1 v levo ↺",
				turnrightamountvalue_options: "obrni se za %1 v desno ↻",
				turnleftamountvalue_moreoptions: "obrni se za %1 v levo ↺",
				turnrightamountvalue_moreoptions: "obrni se za %1 v desno ↻",
				turneitheramount: "obrni se za %1° %2",
				turneitheramountvalue: "obrni se za %1 %2",
				penup: "dvigni sveder",
			...
			messages: {
				paintingWrong: "Pastirček ni izrezal pravega vzorca.",
				paintingCorrect: "Čestitamo! Pišek je naslikal pravi vzorec.",
				paintingFree: "Pišek je naslikal vzorec, ki si ga sprogramiral. Če ga želiš shraniti, posnemi sliko zaslona."
			 },
		},
		none: {
			comment: {
