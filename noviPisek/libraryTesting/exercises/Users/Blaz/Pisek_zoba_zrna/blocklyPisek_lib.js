   ...
   var localLanguageStrings = {
      ...
      sl: {
         label: {
            ...
            dropTransportable: "odloži",
            onTransportable: "na jajcu",
         ...
         messages: {
            ...
            alreadyTransporting: "Pišek že nosi predmet.",
            notTransporting: "Pišek skuša spustiti predmet, vendar ga ne nosi.",
            successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!",
            successMarkersPainted: "Čestitamo, Pišek je pravilno postavil gnezda!",
            failureMarkersPainted: "Pišek ni postavil gnezda na pravo polje.",
            successPickedAllCollectibles: "Čestitamo, Pišek je pobral vsa zrna!",
            failurePickedAllCollectibles: "Pišek ni pobral zrn!",
            successReachGeenArea: "Čestitamo, robot je dosegel zeleno območje!",
            failureReachGeenArea: "Robot ni dosegel zelenega območja!",
            successOneMarbleInHole: "Čestitamo, jajce je v gnezdu!",
            successAllMarblesInHoles: "Čestitamo, vsa jajca so v gnezdu!",
            failureOneMarbleInHole: "Jajce ni v gnezdu!",
            failureAllMarblesInHoles: "Vsa jajca niso v gnezdu!",
            leavesGrid: "Pišek je zapustil mrežo!"
         },
         description: {
            platformAbove: "ploščadZgoraj(): Ali obstaja ploščad nad Piškom?",
            obstacleInFront: "oviraSpredaj(): Ali obstaja ovira pred Piškom?",
            onHole: "naLuknji(): Ali je Pišek na gnezdu?",
            onTransportable: "naPredmetu(): Ali je Pišek na predmetu, ki ga lahko pobere?",
            onRoundObject: "naKrogu(): Ali je Pišek na okroglem predmetu?",
            onSquareObject: "naKvadratu(): Ali je Pišek na kvadratnem predmetu?",
            onTriangleObject: "naTrikotniku(): Ali je Pišek na trikotnem predmetu?",
            onDottedObject: "naPikčastemPredmetu(): Ali je Pišek na pikčastem predmetu?",
            onFullObject: "naPolnemPredmetu(): Ali je Pišek na polnem predmetu?",
            onStripedObject: "naČrtastemPredmetu(): Ali je Pišek na črtastem predmetu?",
            paintOnCell: "pobarvanoPolje(): Ali je polje, na katerem je Pišek, pobarvano?",
            gridEdgeInFront: "robMrežeSpredaj(): Ali je rob mreže pred Piškom?",
            gridEdgeEast: "robMrežeDesno(): Ali je rob mreže desno od Piška?",
            gridEdgeWest: "robMrežeLevo(): Ali je rob mreže levo od Piška?",
            gridEdgeAbove: "robMrežeZgoraj(): Ali je rob mreže nad Piškom?",
            gridEdgeBelow: "robMrežeSpodaj(): Ali je rob mreže pod Piškom?",
            platformInFront: "ploščadSpredaj(): Ali obstaja ploščad pred Piškom?",
            numberUnder: "številkaPolja(): Številka polja, na katerem je Pišek.",
            col: "stolpec(): Stolpec na katerem je Pišek",
            row: "vrstica(): Vrstica na kateri je Pišek",
            paintNorth: "pobarvanaZgoraj(): Ali je pobarvano polje nad poljem, na katerem je Pišek?",
            paintNorthWest: "pobarvanaZgorajLevo(): Ali je pobarvano polje levo nad poljem, na katerem je Pišek?",
            paintNorthEast: "pobarvanaZgorajDesno(): Ali je pobarvano polje desno nad poljem, na katerem je Pišek?",
            writeNumber: "zapišiŠtevilko(številka): Zapiše številko v polje, na katerem je Pišek."
         },
         obstacle: "Pišek poskuša premakniti oviro!",
         startingBlockName: "Program",
         exit_grid: "Pišek je zapustil mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Pišek že nosi predmet.",
         jumpOutsideGrid: "Pišek skuša skočiti izven mreže!",
         jumpObstacleBlocking: "Pišek skuša skočiti, vendar zaradi ovire ne more!",
         jumpNoPlatform: "Pišek skuša skočiti, vendar ni nobene ploščadi!",
         downOutsideGrid: "Pišek se skuša premakniti izven mreže!",
         downNoPlatform: "Pišek se skuša premakniti dol, vendar spodaj ni ploščadi!",
         falls: "Pišek pada v prazno.",
         willFallAndCrash: "Pišek bo padel z ploščadi in se poškodoval!",
         dropWithoutItem: "Pišek skuša spustiti predmet, vendar ga ne nosi.",
