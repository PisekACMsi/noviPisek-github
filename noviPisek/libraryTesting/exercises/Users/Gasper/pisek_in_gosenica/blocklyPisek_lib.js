   ...
   var localLanguageStrings = {
      ...
      sl: {
         label: {
            ...
            pickTransportable: "poberi Gosenico",
            dropTransportable: "odloži Gosenico",
            onTransportable: "pri Gosenici",
         ...
         messages: {
            ...
            alreadyTransporting: "Gosenica je že avtu.",
            notTransporting: "Mama in Pišek skušata odložiti Gosenico, vendar je ni v avtu.",
            ...
            successPickedAllCollectibles: "Čestitamo, Gosenico si pripeljal do avtobusne postaje!",
            failurePickedAllCollectibles: "Gasilka ni pobral vseh predmetov!",
            successReachGeenArea: "Super! Mama je Piška uspešno pripeljala v šolo.",
            failureReachGeenArea: "Ojoj! Mama in Pišek nista uspela priti do šole. Poskusi ponovno!",
            ...
            leavesGrid: "Avto je zapustil mrežo!"
         },
         description: {
            ...
            paintNorthWest: "pobarvanaZgorajLevo(): Ali je pobarvano polje levo nad poljem, na katerem je Pišček?",
         ...
         obstacle: "Ojoj! Avto se je zaletel v drevo. Poskusi še enkrat.",
         startingBlockName: "Program",
         exit_grid: "Avto je zapustil mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Avto že vozi predmet.",
         jumpOutsideGrid: "Avto skuša skočiti izven mreže!",
         jumpObstacleBlocking: "Avto skuša skočiti, vendar zaradi ovire ne more!",
         jumpNoPlatform: "Avto skuša skočiti, vendar ni nobene ploščadi!",
         downOutsideGrid: "Avto se skuša premakniti izven mreže!",
         downNoPlatform: "Avto se skuša premakniti dol, vendar spodaj ni ploščadi!",
         falls: "Avto pada v prazno.",
         willFallAndCrash: "Avto bo padel s ploščadi in se poškodoval!",
         dropWithoutItem: "Voznik avtomobila skuša odložiti predmet, vendar ga ne vozi s seboj.",
