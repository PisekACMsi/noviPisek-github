	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				pickWithdrawable: "poberi vzorec",
				onWithdrawable: "na vzorcu",
			...
			messages: {								//Besedila sporočil
				...
				nothingToPickUp2: "Ni vzorca, ki bi ga lahko pobral.",
				...
				successPickedAllWithdrawables: "Čestitamo, robot je pobral vse vzorce!",
				failurePickedAllWithdrawables: "Robot ni pobral vseh vzorcev!",
