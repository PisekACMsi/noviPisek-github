	...
	var localLanguageStrings = {
		sl: {
			...
			label: {									//Imena ukazov
				...
				paint: "postavi oviro",
				pickTransportable: "poberi zastavico",
				dropTransportable: "pospravi paket",
				onTransportable: "na polju z zastavico",
				pickWithdrawable: "poberi zastavico",
				onWithdrawable: "na polju z zastavico",
				...
				markedCell: "na polju s snežinko",
			...
			messages: {								//Besedila sporočil
				nothingToPickUp: "Ni zastavic, ki bi jih lahko pobral.",
				nothingToPickUp2: "Ni zastavic, ki bi ga lahko pobral.",
				...
				successPickedAllWithdrawables: "Čestitamo, pobral si vse zastavice!",
				failurePickedAllWithdrawables: "Nisi pobral vseh zastavic",
				successReachGeenArea: "Super! Prišel si na cilj.",
				failureReachGeenArea: "Ojoj! Nisi prispel do cilja. Poskusi še enkrat.",
