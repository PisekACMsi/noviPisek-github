   ...
   var localLanguageStrings = {
      ...
      sl: {
         ...
         messages: {
            ...
            alreadyTransporting: "Piščanček Pišček že nosi predmet.",
            notTransporting: "Piščanček Pišček skuša spustiti predmet, vendar ga ne nosi.",
            successDroppedAllObjects: "Čestitamo, spustil(-a) si vse predmete!",
            successMarkersPainted: "Čestitamo, zmajček je pravilno pobarval polja!",
            failureMarkersPainted: "Zmajček ni pravilno pobarval polja.",
            successPickedAllCollectibles: "Čestitamo, piščanček Pišček je pobral vse predmete!",
            failurePickedAllCollectibles: "Piščanček Pišček ni pobral vseh predmetov!",
            ...
            leavesGrid: "Zmajček je zapustil mrežo!"
         },
         description: {
         ...
         obstacle: "Piščanček Pišček poskuša premakniti oviro!",
         startingBlockName: "Program",
         exit_grid: "Piščanček Pišček je zapustil mrežo!",
         nothingToPickUp: "Ni predmetov, ki bi jih lahko pobral.",
         alreadyTransportingObject: "Piščanček Pišček že nosi predmet.",
         jumpOutsideGrid: "Piščanček Pišček skuša skočiti izven mreže!",
         jumpObstacleBlocking: "Piščanček Pišček skuša skočiti, vendar zaradi ovire ne more!",
         jumpNoPlatform: "Piščanček Pišček skuša skočiti, vendar ni nobene ploščadi!",
         downOutsideGrid: "Piščanček Pišček se skuša premakniti izven mreže!",
         downNoPlatform: "Piščanček Pišček se skuša premakniti dol, vendar spodaj ni ploščadi!",
         falls: "Piščanček Pišček pada v prazno.",
         willFallAndCrash: "Piščanček Pišček bo padel z ploščadi in se poškodoval!",
         dropWithoutItem: "Piščanček Pišček skuša spustiti predmet, vendar ga ne nosi.",
