function initTask(subTask) {
    subTask.gridInfos = {				//podatki za urejevalnik in vizualno 
		...
		itemTypes: {
			...
			door: {num: 3, img: ["door_d.png","door_c.png"], id:1, zOrder: 1, category: [{'obstacle':true}, {}], },
			button: {num: 4, img: ["pressure_off.png","pressure_on.png"], id:1, zOrder: 1, category: [{'button':true}, {'button':true,'obstacle':true}], },
		}, 
